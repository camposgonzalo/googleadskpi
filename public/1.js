...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    updateTextArea: function updateTextArea() {
      this.textarea = "".concat(this.form.title_one ? this.form.title_one : "", " ").concat(this.form.title_two ? this.form.title_two : "", "\n\n            ").concat(this.form.description ? this.form.description : "", "\n").concat(this.form.url ? this.form.url : "");
    }
  }
});
